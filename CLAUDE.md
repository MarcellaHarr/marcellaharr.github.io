...
- Root-level HTML files (`r-studio.html`, `excel.html`, `web-dev.html`, `sql-repo.html`, `jupyter.html`, `education.html`, `follow-along.html`) are the per-discipline repo landing pages linked in the nav
...
├── education.html              # Education repo landing page
